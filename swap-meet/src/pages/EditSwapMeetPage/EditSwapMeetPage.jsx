...
class EditSwapMeetPage extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    try {
      ...
      await swapmeetService.updateOne({
        id,
        dateTime,
        showMeetOffer,
      });
          ...
          <div className={styles.outer}>
            ...
            <div className={styles.container}>
              ...
              <input
                type="hidden"
                name="showMeetOffer"
                value={this.props.showMeetOffer}
              />
              <input
                type="hidden"
                name="id"
                id="id"
                value={this.props.showMeet._id}
              />
              <input
                type="datetime-local"
                name="dateTime"
                id="dateTime"
                defaultValue={this.props.showMeet.dateTimeData}
            ...
            <div className={styles.container}>
              <div className={styles.item}>
                <div className={styles.inner}>
                  <img
                    src={this.props.showMeet.wantItem.image}
                    alt={this.props.showMeet.wantItem.name}
                  />
                  <div className={styles.info}>
                    <h1>{this.props.showMeet.wantItem.name}</h1>
                    <h3>
                      <em>{this.props.showMeet.wantItem.itemType}</em>
                    </h3>
                    <p>{this.props.showMeet.wantItem.description}</p>
                    <h3>
                      Looking for:{' '}
                      <em>{this.props.showMeet.wantItem.swapPref}</em>
                    </h3>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.item}>
                <div className={styles.inner}>
                  <img
                    src={this.props.showMeet.offerItem.image}
                    alt={this.props.showMeet.offerItem.name}
                  />
                  <div className={styles.info}>
                    <h1>{this.props.showMeet.offerItem.name}</h1>
                    <h3>
                      <em>
                        {this.props.showMeet.offerItem.itemType}
                      </em>
                    </h3>
                    ...
                    <h3>
                      Looking for:{' '}
                      <em>
                        {this.props.showMeet.offerItem.swapPref}
                      </em>
                    </h3>
                  </div>
                </div>
