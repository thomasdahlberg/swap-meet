              ...
              (
                ...
                <section key={i} className={styles.meet}>
                  ...
                  <div className={styles.info}>
                    <p>
                      <strong>Your Item:</strong> {offerItem.name}
                    </p>
                    <p>
                      <strong>Their Item:</strong> {wantItem.name}
                    </p>
                  </div>
                  {counterOffer && !meetAccepted ? (
                    <div>
                      <h3>
                        <strong>Updated Time for Swapmeet</strong>
                      </h3>
                      <button
                        id={_id}
                        name="agree"
                        onClick={this.handleSwapmeetDecision}
                      >
                        Agree to Swap-Meet
                      </button>
                      <button
          ...
          ? this.props.myOfferedMeets.map(
              (
                ...
                <section key={i} className={styles.meet}>
                  ...
                  <div className={styles.info}>
                    <p>
                      <strong>Your Item:</strong> {wantItem.name}
                    </p>
                    <p>
                      <strong>Their Item:</strong> {offerItem.name}
                    </p>
                  </div>
                  <div>
                    {meetAccepted ? (
                      ...
                      <div>
                        <Link to="" onClick={this.delayRedirect}>
                          <button
                            ...
                            name="counter-offer"
                            onClick={
                              this.props.handleSwapMeetEditView
                            }
                          >
                            Change Date/Time
                          </button>
